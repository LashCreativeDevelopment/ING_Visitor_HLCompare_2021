...
function initHeroFeatureSlider() {
  ...
  //var centerPadding = $(window).innerWidth() - $('.ING-home-hero .hero-image-section .container').outerWidth()

  // Type A adn not Type B has different layout
  // if( $('.ING-home-hero').hasClass('type-a') || !$('.ING-home-hero').hasClass('type-b') ) {
  //   options.centerMode = true;
  //   options.centerPadding = '26px'; //'26px';
  // }

  var options = optionsTypeA;
  if( $('.ING-home-hero').hasClass('type-b') ) {
    // TYPE B
    options = optionsTypeB;
  }
