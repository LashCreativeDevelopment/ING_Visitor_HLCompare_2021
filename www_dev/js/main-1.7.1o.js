/*
 * ING DIRECT Main JS -- Modified for Open Banking
 * open-banking.html
 */
...
(function() {
  ...
  */
  ...
  function updateStickyHeader (e) {
      ...
      var infoHeight = 0; // notification bar
      if( $('#additional-info-box').length ) infoHeight = $('#additional-info-box').outerHeight();
      var heroHeight = $('.ING-tab-header').prev('div, section, article').outerHeight();
      var titleHeight = 0;
      if( $('.ING-tab-header .heading-wrapper').length ) titleHeight = $('.ING-tab-header .heading-wrapper').outerHeight();
