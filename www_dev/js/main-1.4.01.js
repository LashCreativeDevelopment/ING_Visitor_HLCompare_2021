/*
 * ING DIRECT Main JS - TOPLESS LANDING ONLY
 * Sticky Tab Variation - different headerHeight (line 53)
 */
...
var headerBottomHeight = -4; //60; 0 made sticky tab focus to move backwards..
...
function initializeComponents() {
    ...
    //article page fixed sidemenu
	//initializeArticleside();
...
//		console.log(stickyTabIds[index]);
	...
	$('.ING-tab-header .tab-list > li > a').on('click', function(event) {
		...
		// martin - this controlls the tab scroll offset 
